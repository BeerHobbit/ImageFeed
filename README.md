...
Приложение позволяет пользователю просматривать бесконечную ленту изображений, открывать изображения в полноэкранном режиме, ставить лайки, а также просматривать информацию о своем профиле.
